...
// TODO: Add all the operators here as well from params builder
export function equals<
  T extends Record<string, any>,
  K extends keyof NonArrayKeys<Flatten<T>>,
>(column: K, value: NonArrayKeys<Flatten<T>>[K]): Params<Flatten<T>> {
...
export function isOneOf<
  T extends Record<string, any>,
  K extends keyof NonArrayKeys<Flatten<T>>,
>(column: K, values: Array<NonArrayKeys<Flatten<T>>[K]>): Params<Flatten<T>> {
...
>(column: K, value: ArrayKeys<Flatten<T>>[K]): Params<Flatten<T>> {
...
export function any<
  T extends Record<string, any>,
  K extends keyof ArrayKeys<Flatten<T>>,
>(column: K, value: RemoveArray<ArrayKeys<Flatten<T>>[K]>): Params<Flatten<T>> {
